...
# Compress
cd output
echo "Compressing tegra210 CUDA files to output/cuda-${CUDA_VERSION}.${CUDA_MICRO_VERSION}-tegra210.tar.xz"
XZ_OPT=-9 tar cfJ cuda-${CUDA_VERSION}.${CUDA_MICRO_VERSION}-tegra210.tar.xz cuda-${CUDA_VERSION}-tegra210
