...
CUDA_MICRO_VERSION="89"
CUDA_BUILD_NUMBER="440.40"
LIBCUDNN_VERSION="8.0.0.145"
LIBCUDNN_MAJOR_VERSION="8"
HOST_OS="ubuntu1804"
HOST_DEB_FILES="cuda-repo-cross-aarch64-${CUDA_MAJOR_VERSION}-${CUDA_MINOR_VERSION}-local-${CUDA_MAJOR_VERSION}.${CUDA_MINOR_VERSION}.${CUDA_MICRO_VERSION}_1.0-1_all.deb cuda-repo-${HOST_OS}-${CUDA_MAJOR_VERSION}-${CUDA_MINOR_VERSION}-local-${CUDA_MAJOR_VERSION}.${CUDA_MINOR_VERSION}.${CUDA_MICRO_VERSION}-${CUDA_BUILD_NUMBER}_1.0-1_amd64.deb"
TARGET_DEB_FILES="cuda-repo-l4t-${CUDA_MAJOR_VERSION}-${CUDA_MINOR_VERSION}-local-${CUDA_MAJOR_VERSION}.${CUDA_MINOR_VERSION}.${CUDA_MICRO_VERSION}_1.0-1_arm64.deb"
TARGET_DNN_RT_DEB_FILES="libcudnn${LIBCUDNN_MAJOR_VERSION}_${LIBCUDNN_VERSION}-1+cuda${CUDA_VERSION}_arm64.deb"
TARGET_DNN_DEV_DEB_FILES="libcudnn${LIBCUDNN_MAJOR_VERSION}-dev_${LIBCUDNN_VERSION}-1+cuda${CUDA_VERSION}_arm64.deb"
